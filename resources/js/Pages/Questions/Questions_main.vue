...
import{createQuestion,
    ...
    answers_update,
    selected_question,
    question_create_model_show} from './QuestionsFunctions/QuestionsManager';
                    ...
                    <tbody>
                      <tr v-for="(question_obj ,index) in questions"  class="text-center ">
                               ...
                               <td class="flex  border-none items-center gap-0.5 overflow-hidden">
                                  ...
                                  <edit_question class="p-2 border-none  rounded-full bg-white group transition-all duration-500 hover:bg-indigo-600 flex item-center">
                                  ...
                                  <delete_question class="p-2 rounded-full bg-white group transition-all duration-500 hover:bg-red-600 flex item-center">
